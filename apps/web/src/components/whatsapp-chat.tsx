...
export function WhatsAppChat({
  ...
  return (
    <div
      className={`fixed ${positionClasses[position]} z-50 ${!showOnMobile ? 'hidden md:block' : ''}`}
    >
      <AnimatePresence>
        {/* Chat Popup */}
        {isOpen && (
            ...
            <div className="p-4 bg-[#ECE5DD] min-h-[200px] relative">
              ...
              <div className="absolute inset-0 opacity-5">
                <svg width="100%" height="100%">
                  ...
                  >
                    <path
                      d="M0 0L50 50M50 50L100 0M50 50L100 100M50 50L0 100"
                      stroke="#000"
                      strokeWidth="0.5"
                      fill="none"
                    />
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={handleWhatsAppClick}
        className="relative w-11 h-11 bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white rounded-full shadow-2xl flex items-center justify-center hover:shadow-3xl transition-shadow group"
