...
export function LegalPageLayout({
  ...
  // Default related links with translations
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12 print:py-6 print:px-0">
              <div className="grid lg:grid-cols-[1fr_300px] gap-12 print:grid-cols-1 print:gap-0">
                ...
                <div className="max-w-4xl print:max-w-none">
                  <div className="prose prose-lg max-w-none legal-content">{children}</div>
                  ...
                  <div className="mt-16 pt-8 border-t border-neutral-200 print:hidden">
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      {links.map((link) => (
                        ...
                        >
                          <svg
                            className="w-5 h-5 text-neutral-400 group-hover:text-gold transition-colors"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                  ...
                  <div className="mt-8 p-6 bg-neutral-50 rounded-xl border border-neutral-200 print:hidden">
                    <h4 className="font-semibold text-black mb-2">{t('questionsAboutDocument')}</h4>
                    <p className="text-sm text-neutral-600 mb-3">{t('questionsHelp')}</p>
                    <Link
                      href="/contact"
        ...
        <div className="print-document">
          ...
          <div className="print-header">
            ...
            <div className="print-meta">
              {t('lastUpdated')}: {lastUpdated} • {t('effective')}: {effectiveDate} • {t('version')}{' '}
              {version}
            </div>
          </div>

          {/* Content */}
          <div className="legal-content print-content">{children}</div>
        </div>
      </div>
