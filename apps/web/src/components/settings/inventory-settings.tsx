      ...
      >
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
          <p className="text-sm text-blue-800">
            <strong>ℹ️ Automatic SKU Generation:</strong> All product SKUs are automatically
            generated by the system using the pattern:{' '}
            <strong>{`{PREFIX}-{MM}-{DD}-{SEQUENCE}`}</strong>
          </p>
        ...
        <div className="space-y-4">
          <SettingsToggle
            ...
            onCheckedChange={(checked) =>
              form.setValue('enable_stock_notifications', checked, { shouldDirty: true })
            }
