          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-amber-900">
              ...
              <p className="text-amber-700">
                You'll need to log in to PayPal for each purchase. PayPal accounts cannot be saved
                for future use. To save payment methods, please use a credit or debit card instead.
              </p>
            </div>
          </div>
        </div>
