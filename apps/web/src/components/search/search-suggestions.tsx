        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="text-xs text-gray-400 hover:text-[#CBB57B] transition-colors"
            >
              Clear all
            </button>
          </div>
            ...
            {recentSearches.map((term, index) => (
              ...
              >
                <button
                  ...
                  className="flex-1 text-left px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors"
                >
                  <span className="text-sm text-gray-700 group-hover:text-[#CBB57B]">
                    {term}
                  </span>
                </button>
                <button
          ...
          <div className="space-y-1">
            {trending.slice(0, 5).map((item, index) => (
              <motion.button
                ...
                className="w-full text-left px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors group flex items-center justify-between"
              >
                <span className="text-sm text-gray-700 group-hover:text-[#CBB57B]">
                  {item.term}
                </span>
        ...
        <div className="grid grid-cols-2 gap-2">
          {popularCategories.map((category, index) => (
            <motion.button
              ...
              className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-white to-gray-50 hover:from-[#CBB57B]/5 hover:to-[#CBB57B]/10 border border-gray-100 hover:border-[#CBB57B]/30 transition-all group"
            >
              <span className="text-2xl">{category.icon}</span>
              <span className="text-sm font-medium text-gray-700 group-hover:text-[#CBB57B]">
                {category.name}
              </span>
            </motion.button>
          ))}
