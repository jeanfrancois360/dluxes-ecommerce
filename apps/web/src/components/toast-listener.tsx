 ...
 *
 * Listens to toast events from the API client and displays notifications
 */

import { useEffect, useState } from 'react';
import type { ToastMessage } from '@/lib/api/client';
 ...
 * Toast Listener Component
 *
 * Add this component to your root layout to listen for toast notifications
 *
 * @example
 * ```tsx
 * // In app/layout.tsx
