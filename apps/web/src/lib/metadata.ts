...
export const homeMetadata: Metadata = generateSeoMetadata({
  ...
  description: 'Discover extraordinary lifestyle products curated for distinguished living. Shop premium fashion, luxury home decor, high-end electronics, and exclusive designer brands.',
  keywords: [
    'luxury shopping',
    'premium products',
    'designer fashion',
...
export function getProductsMetadata(params?: {
  ...
  let description = 'Browse our curated collection of luxury products from the world\'s finest brands.';
...
export const loginMetadata: Metadata = generateSeoMetadata({
  title: 'Sign In',
  description: 'Sign in to your Luxury Marketplace account to access exclusive features and manage your orders.',
  url: '/auth/login',
  noIndex: true,
  noFollow: true,
});
...
export const registerMetadata: Metadata = generateSeoMetadata({
  ...
  description: 'Join Luxury Marketplace to discover exclusive products, track orders, and enjoy personalized shopping.',
  url: '/auth/register',
  noIndex: true,
  noFollow: true,
});
...
export const aboutMetadata: Metadata = generateSeoMetadata({
  title: 'About Us',
  description: 'Learn about Luxury Marketplace, our mission, and commitment to providing the finest curated products.',
...
export const contactMetadata: Metadata = generateSeoMetadata({
  title: 'Contact Us',
  description: 'Get in touch with our customer service team. We\'re here to help with any questions or concerns.',
