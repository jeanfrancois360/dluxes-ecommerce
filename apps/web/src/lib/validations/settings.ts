...
export const paymentSettingsSchema = z.object({
  ...
  escrow_default_hold_days: z
    .number()
    .int()
    .min(1, 'Hold days must be at least 1')
    .max(90, 'Hold days cannot exceed 90'),
  ...
  stripe_fee_percentage: z
    .number()
    .min(0, 'Fee percentage cannot be negative')
    .max(10, 'Fee percentage cannot exceed 10%')
    .optional(),
  stripe_fee_fixed_eur: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed €5')
    .optional(),
  stripe_fee_fixed_usd: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed $5')
    .optional(),
  stripe_fee_fixed_gbp: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed £5')
    .optional(),
  stripe_fee_fixed_aud: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed A$5')
    .optional(),
  stripe_fee_fixed_cad: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed C$5')
    .optional(),
  stripe_fee_fixed_jpy: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(500, 'Fixed fee cannot exceed ¥500')
    .optional(),
  stripe_fee_fixed_chf: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed CHF 5')
    .optional(),
  stripe_fee_fixed_rwf: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5000, 'Fixed fee cannot exceed FRw 5000')
    .optional(),
  // Payment Processor Fees - PayPal
  paypal_fee_percentage: z
    .number()
    .min(0, 'Fee percentage cannot be negative')
    .max(10, 'Fee percentage cannot exceed 10%')
    .optional(),
  paypal_fee_fixed_eur: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed €5')
    .optional(),
  paypal_fee_fixed_usd: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed $5')
    .optional(),
  paypal_fee_fixed_gbp: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed £5')
    .optional(),
  paypal_fee_fixed_aud: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed A$5')
    .optional(),
  paypal_fee_fixed_cad: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed C$5')
    .optional(),
  paypal_fee_fixed_jpy: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(500, 'Fixed fee cannot exceed ¥500')
    .optional(),
  paypal_fee_fixed_chf: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5, 'Fixed fee cannot exceed CHF 5')
    .optional(),
  paypal_fee_fixed_rwf: z
    .number()
    .min(0, 'Fixed fee cannot be negative')
    .max(5000, 'Fixed fee cannot exceed FRw 5000')
    .optional(),
...
export const securitySettingsSchema = z.object({
  ...
  email_verification_grace_period_days: z
    .number()
    .int()
...
export const notificationSettingsSchema = z.object({
  ...
  notification_events: z
    .array(z.string())
    .min(1, 'At least one notification event must be enabled'),
});
