...
export default function ForgotPasswordPage() {
  ...
  if (isSuccess) {
    return (
      <AuthLayout title={t('checkYourEmail')} subtitle={t('sentResetLink')}>
        <motion.div
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-neutral-500">{t('linkExpires1Hour')}</p>
          </div>
    ...
    <AuthLayout title={t('title')} subtitle={t('subtitle')}>
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-neutral-600">{t('enterEmailForReset')}</p>
        </div>
