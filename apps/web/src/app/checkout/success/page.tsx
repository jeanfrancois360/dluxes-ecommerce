    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white flex items-center justify-center">
        <div className="text-center">
          <svg
            className="animate-spin h-12 w-12 text-gold mb-4 mx-auto"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
        ...
        >
          ...
          <Link href="/account/orders">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-black text-white font-semibold rounded-lg hover:bg-neutral-800 transition-all"
            >
              {t('viewAllOrders')}
            </motion.button>
          </Link>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-neutral-500">
            {t('orderNumber')}{' '}
            <span className="font-mono font-semibold text-black">{order.orderNumber}</span>
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-lg border border-neutral-200 p-6 md:p-8 mb-8"
        >
          ...
          <div className="flex justify-between items-center pt-4 border-t-2 border-neutral-200">
            ...
            <span className="text-2xl font-bold text-black">
              \${formatCurrencyAmount(Number(order.total), 2)}
            </span>
          </div>
        </motion.div>
        ...
        >
          <Link href="/account/orders">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full px-6 py-4 bg-black text-white font-semibold rounded-lg hover:bg-neutral-800 transition-all flex items-center justify-center gap-2"
            >
              {t('viewAllOrders')}
            </motion.button>
          </Link>
          <Link href="/products">
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full px-6 py-4 border-2 border-neutral-200 text-black font-semibold rounded-lg hover:border-gold transition-all flex items-center justify-center gap-2"
            >
              {t('continueShopping')}
            </motion.button>
          </Link>
          <Link href="/">
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full px-6 py-4 border-2 border-neutral-200 text-neutral-700 font-semibold rounded-lg hover:border-neutral-300 transition-all flex items-center justify-center gap-2"
            >
              {t('backToHome')}
            </motion.button>
          </Link>
        ...
        {relatedProducts.length > 0 && (
          ...
          >
            <h2 className="text-2xl font-serif font-bold text-black mb-6 text-center">
              {t('youMightAlsoLike')}
            </h2>
