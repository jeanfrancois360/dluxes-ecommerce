...
function CustomerOrdersContent() {
  ...
  if (loading) {
    return (
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        <PageHeader title="Customer Orders" description="Loading customer orders" />
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      <PageHeader title={`Orders for ${customerName}`} description={customer.email} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
            ...
            <p className="text-2xl font-bold text-black">
              ${formatCurrencyAmount(customer.totalSpent || 0)}
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
            ...
            <p className="text-2xl font-bold text-black">
              ...
              {formatCurrencyAmount(
                customer._count?.orders > 0 ? customer.totalSpent / customer._count.orders : 0
              )}
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
      ...
      <section>
        <h2 className="text-lg font-semibold text-neutral-900 mb-4">Filter Orders</h2>
        <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
      ...
      <section>
        <h2 className="text-lg font-semibold text-neutral-900 mb-4">All Orders</h2>
                ...
                <tbody className="divide-y divide-neutral-200">
                  {orders.map((order) => (
                    <tr key={order.id} className="hover:bg-neutral-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex px-3 py-1.5 rounded-lg text-xs font-semibold border ${getStatusColor(order.status)}`}
                        >
                          {order.status}
                        </span>
                      </td>
