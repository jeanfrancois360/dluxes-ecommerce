  ...
  if (loading) {
    return (
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        <PageHeader title="Customer Details" description="Loading customer information" />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
              ...
              <div className="space-y-4">
                ...
                {customer.orders &&
                  customer.orders.slice(0, 3).map((order: any, index: number) => (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2 border-t border-neutral-200">
                  ...
                  <span
                    className={`text-sm font-medium ${customer.emailVerified ? 'text-green-600' : 'text-neutral-600'}`}
                  >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                  {customer._count?.orders > 0 && (
                    <span className="text-sm text-neutral-600">{customer._count.orders} total</span>
                  )}
