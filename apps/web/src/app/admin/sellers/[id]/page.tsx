              ...
              {!payoutSettings || payoutSettings.id === null ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    {payoutSettings.taxId && (
                      <InfoRow label="Tax ID" value={payoutSettings.taxId} />
                    )}
                  ...
                  {creditHistory.map((tx: any) => (
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        {tx.notes && (
                          <p className="text-xs text-neutral-400 truncate">{tx.notes}</p>
                        )}
                      </div>
            ...
            <div className="py-3">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  The seller must have available credits to be reactivated. Their products will
                  remain archived until they republish them.
                </p>
              </div>
            </div>
            <DialogFooter>
