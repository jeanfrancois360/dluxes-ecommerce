...
export default function SellerEarningsPage() {
  ...
  useEffect(() => {
    if (user && user.role === 'SELLER') {
      setIsLoading(true);
      Promise.all([fetchSummary(), fetchCommissions(), fetchPayouts()])
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-xs text-neutral-400 mt-1">
                {summary?.paid.count || 0} paid orders
              </p>
            </motion.div>
          </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6">
                ...
                <div className="space-y-4">
                  {commissions.slice(0, 5).map((commission) => (
                    <div key={commission.id} className="flex items-center justify-between py-3 border-b border-neutral-100 last:border-0">
                      <div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6">
                ...
                <div className="space-y-4">
                  {payouts.slice(0, 5).map((payout) => (
                    <div key={payout.id} className="flex items-center justify-between py-3 border-b border-neutral-100 last:border-0">
                      <div>
                        <p className="font-medium text-black">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-100">
              ...
              {commissionTotalPages > 1 && (
                <div className="p-4 border-t border-neutral-100 flex items-center justify-between">
                  <p className="text-sm text-neutral-500">
                    Showing {((commissionPage - 1) * pageSize) + 1} - {Math.min(commissionPage * pageSize, commissionTotal)} of {commissionTotal}
                  </p>
                  <div className="flex items-center gap-2">
                    <button
          ...
          {activeTab === 'payouts' && (
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-100">
              ...
              {payoutTotalPages > 1 && (
                <div className="p-4 border-t border-neutral-100 flex items-center justify-between">
                  <p className="text-sm text-neutral-500">
                    Showing {((payoutPage - 1) * pageSize) + 1} - {Math.min(payoutPage * pageSize, payoutTotal)} of {payoutTotal}
                  </p>
                  <div className="flex items-center gap-2">
                    <button
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-2xl p-6">
            ...
            <div className="space-y-2 text-sm text-blue-800">
              <p>
                <strong>Pending:</strong> Earnings from orders that are still being processed or in escrow.
              </p>
              <p>
                <strong>Confirmed:</strong> Earnings ready for payout after order delivery confirmation.
              </p>
              <p>
