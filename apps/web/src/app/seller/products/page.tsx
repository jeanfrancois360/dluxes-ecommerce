                      ...
                      <td className="px-6 py-4">
                        {product.heroImage ? (
                          <div className="relative w-14 h-14 rounded-lg overflow-hidden ring-2 ring-neutral-300 hover:ring-gold transition-all group">
                            ...
                            />
                            {/* Fallback placeholder shown when image URL fails to load */}
                            <div className="w-full h-full bg-gradient-to-br from-neutral-100 to-neutral-200 items-center justify-center hidden">
                              <svg
