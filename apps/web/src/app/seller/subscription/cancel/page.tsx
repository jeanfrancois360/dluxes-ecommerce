          ...
          <div className="p-8 sm:p-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                You cancelled the checkout process or closed the payment window before completing
                your subscription purchase. No charges have been made to your payment method.
              </p>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-1">No worries!</h3>
                    <p className="text-blue-800 text-sm">
                      Your account is safe and you can retry the subscription purchase anytime. All
                      our plans come with a 14-day free trial.
                    </p>
                  </div>
                </div>
              </div>
