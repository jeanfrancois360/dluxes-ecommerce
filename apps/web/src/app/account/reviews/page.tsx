        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="bg-white rounded-xl p-4 border border-neutral-100">
              ...
              <p className="text-sm text-neutral-600">{t('published')}</p>
            </div>
            <div className="bg-white rounded-xl p-4 border border-neutral-100">
          ...
          {reviews.length === 0 ? (
            ...
            >
              ...
              <p className="text-neutral-600 mb-6 max-w-md mx-auto">{t('noReviewsDesc')}</p>
              <Link
                href="/account/orders"
                      ...
                      {review.images && review.images.length > 0 && (
                        <div className="flex gap-2 mt-3">
                          {review.images.slice(0, 4).map((image, imgIndex) => (
                            <div
                              key={imgIndex}
                              className="w-16 h-16 rounded-lg overflow-hidden bg-neutral-100"
                            >
                              <img
                                src={image}
          ...
          >
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-neutral-600">{t('deleteReviewConfirm')}</p>
              </div>
