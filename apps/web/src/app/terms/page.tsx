...
export default function TermsPage() {
  ...
  const sections = [
    ...
    { id: 'account-security', title: t('sections.accountSecurity') },
    { id: 'platform-usage', title: t('sections.platformUsage') },
    { id: 'product-listings', title: t('sections.productListings') },
    { id: 'multi-vendor', title: t('sections.multiVendor') },
    { id: 'shipping', title: t('sections.shipping') },
    { id: 'returns', title: t('sections.returns') },
    { id: 'reviews', title: t('sections.reviews') },
    { id: 'prohibited', title: t('sections.prohibited') },
    { id: 'privacy', title: t('sections.privacy') },
    { id: 'disclaimers', title: t('sections.disclaimers') },
    { id: 'indemnification', title: t('sections.indemnification') },
    { id: 'disputes', title: t('sections.disputes') },
    { id: 'platform-features', title: t('sections.platformFeatures') },
    ...
    >
      ...
      <section id="introduction" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          Welcome to NextPik ("we," "our," or "us"). These Terms of Service ("Terms") govern your
          access to and use of the NextPik platform, including our website, mobile applications, and
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          By creating an account, browsing products, making a purchase, or otherwise using our
          Platform, you acknowledge that you have read, understood, and agree to be bound by these
          Terms and our Privacy Policy. If you do not agree to these Terms, you must not use the
          Platform.
        </p>
      ...
      <section id="account-security" className="mb-12 scroll-mt-24">
        ...
        <ul className="list-disc pl-6 text-neutral-700 space-y-2 mb-6 leading-relaxed">
          <li>
            <strong>Buyer Account:</strong> For purchasing products
          </li>
          <li>
            <strong>Seller Account:</strong> For selling products (subject to additional Seller
            Agreement)
          </li>
          <li>
            <strong>Delivery Partner Account:</strong> For providing delivery services
          </li>
          <li>
            <strong>Admin Account:</strong> For platform management (by invitation only)
          </li>
        </ul>
        ...
        <p className="text-neutral-700 leading-relaxed">
          ...
          these Terms, fraudulent activity, or extended period of inactivity. You may terminate your
          account at any time by contacting customer support.
        </p>
      </section>
      ...
      <section id="platform-usage" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-3">
          You may use the Platform only for lawful purposes and in accordance with these Terms. You
          agree not to:
        </p>
        <ul className="list-disc pl-6 text-neutral-700 space-y-2 mb-6 leading-relaxed">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          designs, is the property of NextPik or our licensors and is protected by copyright,
          trademark, and other intellectual property laws.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">3.3 User-Generated Content</h3>
        <p className="text-neutral-700 leading-relaxed">
          By posting content on the Platform (reviews, comments, product listings), you grant
          NextPik a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and
      ...
      <section id="product-listings" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          Product listings on the Platform are created by sellers. While we strive for accuracy, we
          cannot guarantee that all product descriptions, images, prices, and availability
          information are complete, accurate, or current. You should verify important information
          before making a purchase.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">4.2 Pricing and Payment</h3>
        <p className="text-neutral-700 leading-relaxed mb-3">
          All prices are displayed in the currency you select. We accept the following payment
          methods:
        </p>
        <ul className="list-disc pl-6 text-neutral-700 space-y-2 mb-6 leading-relaxed">
        ...
        <p className="text-neutral-700 leading-relaxed">
          When you place an order, you will receive an email confirmation. This confirmation does
          not signify our acceptance of your order, nor does it constitute confirmation of our offer
          to sell. We reserve the right to accept or decline your order for any reason.
        </p>
      </section>
      ...
      <section id="multi-vendor" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          NextPik operates as a multi-vendor marketplace. We provide the platform that enables
          transactions between buyers and sellers, but we are not a party to the transaction itself.
          The contract of sale is directly between you and the seller.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">5.2 Seller Responsibility</h3>
        <p className="text-neutral-700 leading-relaxed mb-4">
          Sellers are responsible for their product listings, inventory accuracy, order fulfillment,
          and customer service. While we monitor seller activity and maintain quality standards, we
          are not responsible for seller actions or product quality.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">5.3 Escrow System</h3>
        <p className="text-neutral-700 leading-relaxed">
          For buyer protection, payments are held in escrow until order delivery is confirmed. This
          ensures that sellers fulfill their obligations before receiving payment. The typical
          escrow hold period is 7 days after delivery.
        </p>
      </section>
      ...
      <section id="shipping" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          Sellers determine available shipping methods and rates. Estimated delivery times are
          provided at checkout and are estimates only. Actual delivery times may vary based on
          location, shipping method, and other factors.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">6.2 Shipping Delays</h3>
        <p className="text-neutral-700 leading-relaxed mb-4">
          We are not responsible for delays caused by shipping carriers, customs clearance, weather
          events, or other circumstances beyond our or the seller's control.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">6.3 International Shipping</h3>
        <p className="text-neutral-700 leading-relaxed">
          For international orders, you are responsible for all customs duties, import taxes, and
          fees imposed by your country. These charges are not included in the product price or
          shipping cost.
        </p>
      </section>
      ...
      <section id="returns" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          Each seller sets their own return policy. You can view the specific return policy for each
          product on the product page. If you are not satisfied with your purchase, please contact
          the seller directly through the Platform.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">7.2 Refund Processing</h3>
        <p className="text-neutral-700 leading-relaxed mb-4">
          Approved refunds are processed within 5-10 business days and will be credited to your
          original payment method. Shipping costs are generally non-refundable unless the product
          was defective or incorrect.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">7.3 Order Cancellation</h3>
        <p className="text-neutral-700 leading-relaxed">
          You may cancel an order before it ships. Once shipped, the seller's return policy applies.
          Contact the seller directly to request cancellation of an unshipped order.
        </p>
      </section>
      ...
      <section id="reviews" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed">
          We reserve the right to remove reviews that violate our guidelines, contain prohibited
          content, or are suspected to be fake or manipulated. We do not verify the accuracy of
          reviews.
        </p>
      </section>
      ...
      <section id="prohibited" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-3">You may not use the Platform to:</p>
        <ul className="list-disc pl-6 text-neutral-700 space-y-2 mb-6 leading-relaxed">
      ...
      <section id="privacy" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed">
          ...
          processing through Stripe, and regular security audits. However, no system is completely
      ...
      <section id="disclaimers" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, NEXTPIK SHALL NOT BE LIABLE FOR ANY INDIRECT,
        ...
        <p className="text-neutral-700 leading-relaxed">
          ...
          exceed the amount you paid to us in the 12 months preceding the claim, or $100, whichever
          is greater.
        </p>
      </section>
      ...
      <section id="indemnification" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed">
          You agree to indemnify, defend, and hold harmless NextPik, its affiliates, officers,
          directors, employees, and agents from any claims, damages, losses, liabilities, and
          expenses (including legal fees) arising from: (a) your use of the Platform; (b) your
          violation of these Terms; (c) your violation of any rights of third parties; or (d) any
      ...
      <section id="disputes" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          If you have a dispute with a seller, we encourage you to contact them directly through the
          Platform. Most issues can be resolved through direct communication.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">13.2 Dispute Center</h3>
        <p className="text-neutral-700 leading-relaxed mb-4">
          If you cannot resolve the dispute directly, you may open a case in our Dispute Center. We
          will review the case and attempt to facilitate a resolution between you and the seller.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">13.3 Arbitration</h3>
        <p className="text-neutral-700 leading-relaxed">
          Any disputes that cannot be resolved through our Dispute Center shall be resolved through
          binding arbitration in accordance with the rules of the American Arbitration Association,
          rather than in court, except as permitted by law.
        </p>
      </section>
      ...
      <section id="platform-features" className="mb-12 scroll-mt-24">
        ...
        <p className="text-neutral-700 leading-relaxed mb-4">
          We use algorithms to provide search results and product recommendations. Results may be
          influenced by relevance, seller performance, product popularity, and other factors.
        </p>

        <h3 className="text-2xl font-semibold text-black mb-4">14.2 Currency and Language</h3>
        <p className="text-neutral-700 leading-relaxed mb-4">
          The Platform supports multiple currencies and languages. Currency conversion rates are
          updated regularly but may not reflect real-time exchange rates. Actual charges may differ
          slightly based on your payment provider's rates.
        </p>
      ...
      <section id="contact" className="mb-12 scroll-mt-24">
        ...
        <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-6">
          <ul className="text-neutral-700 space-y-2">
            <li>
              <strong>Email:</strong> legal@nextpik.com
            </li>
            <li>
              <strong>Support:</strong> support@nextpik.com
            </li>
            <li>
              <strong>Address:</strong> NextPik Inc., [Address to be added]
            </li>
            <li>
      ...
      <section id="acknowledgment" className="mb-12 scroll-mt-24">
        ...
        <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-6">
          <p className="text-neutral-800 font-semibold leading-relaxed mb-3">
            BY USING THE NEXTPIK PLATFORM, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE
            TO BE BOUND BY THESE TERMS OF SERVICE.
          </p>
          <p className="text-neutral-700">
            If you have any questions or concerns about these Terms, please contact us before using
            the Platform.
          </p>
        </div>
      </section>
