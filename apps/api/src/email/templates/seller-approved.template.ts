...
export const sellerApprovedTemplate = (data: {
  ...
  const content = `
    ...
    <p style="color: #525252; font-size: 18px; line-height: 1.6; margin-bottom: 32px; text-align: center;">
      Hello ${data.sellerName}, we're excited to welcome you as a seller on NextPik!
    </p>

    <div style="background: linear-gradient(135deg, #F0FDF4 0%, #DCFCE7 100%); border-radius: 12px; padding: 32px; margin: 32px 0; border: 2px solid #10B981;">
      <h3 style="color: #000000; font-size: 20px; font-weight: 600; margin-bottom: 12px; text-align: center;">
        ✅ ${data.storeName}
      </h3>
      <p style="color: #047857; font-size: 16px; text-align: center; font-weight: 500;">
      ...
      <div style="display: grid; gap: 20px;">
        ...
        <div style="display: flex; gap: 16px;">
          ...
          <div>
            <h4 style="color: #000000; font-size: 16px; font-weight: 600; margin-bottom: 4px;">
              Purchase Selling Credits
            </h4>
            <p style="color: #737373; font-size: 14px; line-height: 1.5;">
              Get monthly credits at $29.99/month to activate your products and start selling.
            </p>
          </div>
        </div>
        ...
        <div style="display: flex; gap: 16px;">
          ...
          <div>
            ...
            <p style="color: #737373; font-size: 14px; line-height: 1.5;">
              Add your products with high-quality images and detailed descriptions.
            </p>
          </div>
        </div>
        ...
        <div style="display: flex; gap: 16px;">
          ...
          <div>
            ...
            <p style="color: #737373; font-size: 14px; line-height: 1.5;">
              Manage orders, track sales, and grow your business from your seller dashboard.
            </p>
          </div>
        </div>
      </div>
    ...
    <div style="text-align: center; margin: 40px 0;">
      <a href="${data.creditsUrl}"
         style="display: inline-block; background: linear-gradient(135deg, #CBB57B 0%, #A89968 100%); color: #000000; padding: 16px 48px; border-radius: 12px; text-decoration: none; font-weight: 600; font-size: 16px; box-shadow: 0 4px 16px rgba(203, 181, 123, 0.3); margin-right: 12px;">
        Purchase Credits
      </a>
    ...
    <div style="background-color: #FEF3C7; border-left: 4px solid #CBB57B; padding: 20px; border-radius: 8px; margin-top: 32px;">
      <p style="color: #525252; font-size: 14px; line-height: 1.6;">
        <strong style="color: #000000;">💡 Important:</strong><br/>
        To publish products and start selling, you need to purchase monthly credits. Credits are automatically deducted on the 1st of each month. You'll receive notifications when your balance is low.
      </p>
    </div>

    <p style="color: #737373; font-size: 14px; text-align: center; margin-top: 32px; line-height: 1.6;">
      Questions about selling on NextPik?<br/>
      <a href="{{SUPPORT_URL}}" style="color: #CBB57B; text-decoration: none; font-weight: 500;">Contact our seller support team</a>
    </p>
  `;
