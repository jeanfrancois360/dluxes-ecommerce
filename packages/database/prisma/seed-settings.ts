...
const defaultSettings = [
  ...
  },
  {
    ...
    description: 'When to capture authorized payments: IMMEDIATE, ON_DELIVERY, ON_DELIVERY_WITH_FALLBACK, or MANUAL',
    isPublic: false,
    isEditable: true,
    requiresRestart: false,
  ...
  },
  {
    ...
    description: 'Auto-capture on this day if not delivered (max 7 days before Stripe authorization expires)',
    isPublic: false,
    isEditable: true,
    requiresRestart: false,
    defaultValue: 6,
  ...
  // SECURITY: API keys MUST be in .env, NEVER in database
  {
    ...
    description: 'DHL API environment: sandbox (for testing) or production (API keys stored in .env)',
    isPublic: false,
    isEditable: true,
    requiresRestart: true,
