      ...
      {products.map((product, index) => (
        ...
        >
          <div className="flex flex-col sm:flex-row">
            {/* Product Image */}
            <div
              className="relative sm:w-80 aspect-square sm:aspect-[4/3] bg-neutral-100 flex-shrink-0 cursor-pointer"
            ...
            <div className="flex-1 p-6 flex flex-col justify-between">
              <div>
                ...
                <h3
                  className="text-xl font-semibold text-black mb-2 line-clamp-2 cursor-pointer hover:text-gold transition-colors"
                  onClick={() => onNavigate?.(product.slug || product.id)}
                >
                  {product.name}
                </h3>
